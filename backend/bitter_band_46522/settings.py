"""
Django settings for bitter_band_46522 project.
...
ROOT_URLCONF = 'bitter_band_46522.urls'
...
WSGI_APPLICATION = 'bitter_band_46522.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bitter_band_46522 API",
    "DESCRIPTION": "API documentation for bitter_band_46522 App",
    "VERSION": "v1",
}
